...
// Pipe me through:                                                       //LLVM
// sed -e '/\/\/LLVM$/d' -e 's/^.*\/\/LLVM //'                            //LLVM
// to get the LLVM source                                                 //LLVM
                                                                          //LLVM
#include <cassert>
...
//LLVM using llvm::itanium_demangle::OutputBuffer;
//LLVM using llvm::itanium_demangle::StringView;
                                                                          //LLVM
#include "StringView.h"                                                   //LLVM
#include "OutputBuffer.h"                                                 //LLVM
#include "OxCamlDemangle.h"                                               //LLVM
